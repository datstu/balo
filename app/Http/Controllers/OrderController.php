...
class OrderController extends Controller
{
	...
	public function view_order($order_id){
		...
		->select('tbl_order.*','tbl_customers.*','tbl_shipping.*','tbl_order_details.*')->first();
		 $list_detail_order = DB::table('tbl_order_details')->where('order_id',$order_id)->get();
		//print_r($list_detail_order);
		 
		$manage_order_by_id = view('admin.view_order')->with('order_by_id',$order_by_id)->with('list_detail_order',$list_detail_order);
    ...
    public function manage_order(){
        ...
        $list_payment =  DB::table('tbl_payment')->get();




        $manager_order  = view('admin.manage_order')->with('all_order',$all_order)->with('list_payment',$list_payment);
