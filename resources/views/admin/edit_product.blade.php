                                    ...
                                    <label for="exampleInputPassword1">Danh mục sản phẩm</label>
                                      <select name="product_cate" class="form-control input-sm m-bot15">
                                        @foreach($cate_product as $key => $cate)
                                            @if($cate->IDLoai==$pro->IDLoai)
                                            <option selected value="{{$cate->IDLoai}}">{{$cate->TenLoai}}</option>
                                            @else
                                            <option value="{{$cate->IDLoai}}">{{$cate->TenLoai}}</option>
                                            @endif
                                        @endforeach
                                    ...
                                    <label for="exampleInputPassword1">Thương hiệu</label>
                                      <select name="product_brand" class="form-control input-sm m-bot15">
                                        @foreach($brand_product as $key => $brand)
                                             @if($cate->IDLoai==$pro->IDLoai)
                                            <option selected value="{{$brand->IDnhasanxuat}}">{{$brand->TenNhasanxuat}}</option>
                                             @else
                                            <option value="{{$brand->IDnhasanxuat}}">{{$brand->TenNhasanxuat}}</option>
                                             @endif
                                        @endforeach
