...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__language">
                                <img src="{{asset('public/frontend/images/language.png')}}" alt="">
                                <div>English</div>
                                <span class="arrow_carrot-down"></span>
                                <ul>
                                    <li><a href="#">Spanis</a></li>
    ...
    @foreach($chitietbalo as $chitiet)
        <div class="container">
            <div class="row">
                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large"
                                src="{{URL::to('public/frontend/images/'.$chitiet->product_image)}}" alt="">
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price"><?php echo $chitiet->product_price; ?>  VNĐ</div>
    ...
    <section class="related-product">
        ...
        <div class="container">
            ...
            <div  class="row">
                @foreach($lq as $lq)
                <div style="text-align: right;" class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{URL::to('public/frontend/images/'.$lq->product_image)}}">
